...
db: 
	docker run --rm -P --name transaction-pg -v ./build/docker/schema.sql:/docker-entrypoint-initdb.d/schema.sql -p 172.17.0.1:5432:5432 -e POSTGRES_PASSWORD=pismo -e POSTGRES_USER=pismo   postgres:16.2-alpine
