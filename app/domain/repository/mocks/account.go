...
func (_m *Account) Get(ctx context.Context, ID int64) (*model.Account, error) {
...
// Save provides a mock function with given fields: ctx, acc
func (_m *Account) Save(ctx context.Context, acc *model.Account) (*model.Account, error) {
